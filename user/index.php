					                                    ...
					                                    <div class="et-banner-content-inner container">
					                                        <div class="et-banner-text h_right v_center align_right">
					                                            <div class="et-banner-text-inner">
					                                                ...
					                                                <a href="product.php?product_no=<?php echo $slider_fetch['product_id']; ?>" class="et-banner-link button et_btn link color- menuu-items">Shop Now</a>
					                                            </div>
					                                        </div>
					                                    </div>
					                                </div>
...
if(isset($_GET['change'])){
	?><script>
		Snackbar.show({ text: 'password change', duration: 2000, });
			var queryParams = new URLSearchParams(window.location.search);
