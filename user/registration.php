									...
									<div class="et-overflow-container et-login-wrapper no_popup" align="center">
										...
										<div class="col-xl-6 col-lg-6 col-md-8 col-sm-10 col-sm-6 border pr-5 pl-5" id="reg-form" >
											<div id="et-login-form">
												...
												<h2 class="page-title" id="reg-title">Registration</h2>
												<!--link style -->
												<style>
												...
												<!--end -->
												<form id="registrationForm" class="woocommerce-form woocommerce-form-login login" method="post">
                                                <div align="center">
                                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-50 pl-2">
													...
													<input type="text" class="woocommerce-Input woocommerce-Input--text input-text " name="firstname" id="firstname" autocomplete="firstname" value="" pattern="[a-zA-Z]+" minlength="3" maxlength="20" required title="Only Characters" />
												</p>

                                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-50 pl-2">
													<label for="lastname" class="ml-2">Last Name&nbsp;<span class="required">*</span></label>
													<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="lastname" id="lastname" autocomplete="lastname" value="" pattern="[a-zA-Z]+" minlength="3" maxlength="20" required title="Only Characters" />					
												</p>
												</div>
                                                <div align="center" style="margin-top: -25px;">
													<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-50 pl-1 pr-1">
														...
														<input type="email" class="woocommerce-Input woocommerce-Input--text input-text" name="email" id="email" autocomplete="email" value="" maxlength="40" required />					
													</p>

	                                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-50 pl-2">
														<label for="mobileno" class="ml-2">Mobile number&nbsp;<span class="required">*</span></label>
														<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="mobileno" id="mobileno" autocomplete="mobileno" value="" pattern="[0-9]{10}" maxlength="10" title="Only Numbers 0-9 with 10 digits" required />			
													</p>
												...
												<div align="center" style="margin-top: -25px;">
													<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-50 pl-1 pr-1">
														<label for="password" class="ml-2">Password&nbsp;<span class="required">*</span></label>
														<input autocomplete="nofill" class="woocommerce-Input woocommerce-Input--text input-text" type="password" name="pass" id="password" pattern="(?=[A-Za-z0-9@#$%^&+!=]+$)^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[@#$%^&+!=])(?=.{6,}).*$" title="Atleast 1 uppercase , 1 lowercase , 1 special character and 1 number with length 6" maxlength="6" required  />
													</p>

	                                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-50 pl-2">
														<label for="conpassword" class="ml-2">Confirm Password&nbsp;<span class="required">*</span></label>
														<input class="woocommerce-Input woocommerce-Input--text input-text" type="password" name="conpassword" id="conpassword" maxlength="6" required />
													</p>
												...
												<div align="center">
	                                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-100 pl-1 pr-1">
														...
														<textarea class="woocommerce-Input woocommerce-Input--text input-textarea" name="addr" id="address" style="width:100%;" required maxlength="500"></textarea>
													</p>
												</div>
												<div align="center" style="margin-top: 15px;">
													<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-100 pl-1 pr-1">
														<label for="pincode" class="ml-2">pincode&nbsp;<span class="required">*</span></label>
														<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="pincode" id="pincode" autocomplete="pincode" value="" pattern="[0-9]{6}" maxlength="6" title="Only Numbers 0-9 with 6 digits" required />				
													</p>
												</div>
												<div align="center">
														<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-50 pl-2">
															<label for="state" class="ml-2">State&nbsp;<span class="required">*</span></label>
															<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="state" id="state" autocomplete="state" value="" readonly="" onclick="handleStateClick();" />
																
														</p>
														<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide d-inline-block w-50 pl-2">
															<label for="city" class="ml-2">City&nbsp;<span class="required">*</span></label>
															<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="city" id="city" autocomplete="city" value="" readonly="" onclick="handleStateClick();" />
		                                                </p>
	                                                </div>
												...
												<div class="col-xl-12">
													<p class="">
														<button type="submit" class="woocommerce-button button woocommerce-form-login__submit w-100 text-center"  name="submit" id="submit" value="Log in">SignUp</button>
													</p>
												</div>
													<p class="form-actions extra mt-2">already a member?<a href="login.php" class="links">Login</a></p>
												</form><br>
											</div>
										</div>
									</div>
...
if (isset($_POST['submit']))
{
	...
	$query = "select * from user where email='$email' or mobile_no = '$mobile_no'";
	$sql = mysqli_query($con , $query);
	if(mysqli_num_rows($sql) > 0)
	{
		?><script type="text/javascript">Snackbar.show({text: 'Email or Mobile Number Already Registered' , duration: 3000})</script><?php
	}
	else
	{
		...
		$query = "INSERT INTO user(name,email,mobile_no,password,address,state,city,pincode,modify_date) VALUES ('$name','$email','$mobile_no','$pass','$add','$state','$city','$pincode','$modify_date')";
		$run = mysqli_query($con,$query);
		if($run == true)
		{
			?><script type="text/javascript">location.replace("login.php?success=1");</script><?php   

		}
		else
		{
			?><script type="text/javascript">location.replace("registration.php?error=1");</script><?php   
		}
	}
}
?>
...
{   
    ?><script type="text/javascript">
    Snackbar.show({ text: 'Registration Completed', duration: 2000, });
