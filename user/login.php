									...
									<div class="et-overflow-container et-login-wrapper no_popup">
										<div class="et-form-container">
											<div id="et-login-form" class="">
												...
												<!--end -->
												<form class="woocommerce-form woocommerce-form-login login" method="post" action="auth_login.php">
												<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
													<label for="username">Email address or Mobile number&nbsp;<span class="required">*</span></label>
												...
												<div class="form-group text-center">
													<a href="password_recovery.php" class="text-center links">Lost your password?</a>
												</div>
												<p class="form-actions">
													<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Log in">Log in</button>
												</p>
												<p class="form-actions extra">Not a member?<a href="registration.php" class="links">Register</a></p>
												</form>
											</div>
										</div>
									</div>
...
if(isset($_GET['login_error'])){
	?><script>
		Snackbar.show({ text: 'Username or password incorrect', duration: 2000, });
			var queryParams = new URLSearchParams(window.location.search);
			queryParams.delete("login_error");
...
if(isset($_GET['deactivate'])){
	?><script>
		Snackbar.show({ text: 'Account deactivated', duration: 2000, });
			var queryParams = new URLSearchParams(window.location.search);
			queryParams.delete("deactivate");
			history.pushState(null, null, "?"+queryParams.toString());
	</script>
	<?php
}
...
if(isset($_GET['success'])){
	?><script>
		...
		Snackbar.show({ text: 'Registration Succesful', duration: 2000, });
			var queryParams = new URLSearchParams(window.location.search);
...
{   
    ...
    Snackbar.show({ text: 'Password Reset Successfully', duration: 4000});
    var queryParams = new URLSearchParams(window.location.search);
...
{   
    ?><script type="text/javascript">
     Snackbar.show({ text: 'There is some error! Please Try Again later.', duration: 4000 });
    var queryParams = new URLSearchParams(window.location.search);
...
{   
    ?><script type="text/javascript">
     Snackbar.show({ text: 'You Reset Password once or link is expired.', duration: 4000});
    var queryParams = new URLSearchParams(window.location.search);
    queryParams.delete("reset_error");
    history.pushState(null, null, "?"+queryParams.toString());
    </script><?php
...
{   
    ?><script type="text/javascript">
    Snackbar.show({ text: 'You need to be login First', duration: 4000});
    var queryParams = new URLSearchParams(window.location.search);
    queryParams.delete("login_first");
    history.pushState(null, null, "?"+queryParams.toString());
    </script><?php
}
?>
