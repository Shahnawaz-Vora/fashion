...
$order_sql = mysqli_query($con,"select * from orders where payment_id='$payment_id'");

$user_order = mysqli_fetch_assoc($order_sql);
                                ...
                                <div class="row inv--head-section">
                                    ...
                                    <div class="col-sm-6 col-12 align-self-center text-sm-right mb-2">
                                        <div class="company-info">
                                            <img src="../../assets/img/logo.png" style="width:150px; height:30px;" class="navbar-logo" alt="logo" >
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $discount=0;
                                                    $final=0;
                                                    $order_query = mysqli_query($con,"select * from orders where payment_id='$payment_id'");
