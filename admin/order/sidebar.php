                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="user" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="../user/manage_user_table.php"> Manage User </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="test" data-parent="#accordionExample">
                            <li>
                                <a href="../product/add_product.php"> Add Item </a>
                            </li>
                            <li>
                                <a href="../product/select_manage_product.php"> Manage Item </a>
                            </li>
                        </ul>
                    </li>
                    
                    <li class="menu">
                        <a href="manage_orders.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clipboard"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect></svg>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="slider" data-parent="#accordionExample">
                            <li>
                                <a href="../slider/select_product_slider.php"> Add Slider </a>
                            </li>
                            <li>
                                <a href="../slider/manage_slider_table.php"> Manage Slider </a>
                            </li>
                        </ul>
                    ...
                    <li class="menu">
                        <a href="../review.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
