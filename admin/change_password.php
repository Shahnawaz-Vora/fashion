                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="password" name="opassword" class="form-control mb-4" required id="opassword" placeholder="Old Password">
                                                                        </div>
                                                                    </div>                           
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="password" name="password" class="form-control mb-4" id="password" autocomplete="" pattern="(?=[A-Za-z0-9@#$%^&+!=]+$)^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[@#$%^&+!=])(?=.{6,}).*$" title="Atleast 1 uppercase , 1 lowercase , 1 special character and 1 number with length 6" maxlength="6" required placeholder="New Password">
                                                                        </div>
                                                                    </div>                             
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="password" name="cpassword" class="form-control" maxlength="6" id="conpassword" required placeholder="Confirm Password">
...
<?php
    ...
    if (isset($_POST['submit'])) {
        $opassword = mysqli_escape_string($con, $_POST['opassword']);
        $password = mysqli_escape_string($con, $_POST['password']);
        $cpassword = mysqli_escape_string($con, $_POST['cpassword']);
        $admin_id = $_COOKIE['admin_id'];
        $sql = "select * from admin where password = '$opassword' and admin_id='$admin_id'";
