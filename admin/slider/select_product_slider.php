...
<head>
    ...
    <title>Select Product Slider | Fashion</title>
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item" aria-current="page"><span>Select Product Slider</span></li>
                            </ol>
                        </nav>
            ...
            <div class="container">
                    <div class="row layout-spacing">
                        <div class="col-lg-12 col-12 layout-spacing">                
                            <form class="section general-info" action="" method="post" id="form1">
    ...
    <script>
        ...
        function manage_product(){
            ...
            else
            {
                ...
                {
                    location.href="add_slider.php?category="+category+"&subcategory="+subcategory;
                }
                else
                {
...
if(isset($_GET['error']))
{
    ...
    Snackbar.show({ text: 'Product not Found in this category', duration: 2000, });
...
{
    ?><script type="text/javascript">
    Snackbar.show({ text: 'Slider Full', duration: 2000, });
    var queryParams = new URLSearchParams(window.location.search);
    queryParams.delete("full");
    history.pushState(null, null, "?"+queryParams.toString());
    </script><?php
}
...
{
    ?><script type="text/javascript">
    Snackbar.show({ text: 'Slider Added', duration: 2000, });
    var queryParams = new URLSearchParams(window.location.search);
