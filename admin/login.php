            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log In to <a href="index.php"><br><span class="brand-name">Seller Dashbord</span></a></h1><br>
                        <form class="text-left" method="POST" action="auth_login.php">
                            <div class="form">
...
{   
    ...
    Snackbar.show({ text: 'Login Successfully', duration: 4000, });
...
{   
    ?><script type="text/javascript">
    Snackbar.show({ text: 'Wrong Username or Password', duration: 4000, });
    var queryParams = new URLSearchParams(window.location.search);
...
{   
    ?><script type="text/javascript">
    Snackbar.show({ text: 'Please login First', duration: 4000, });
    var queryParams = new URLSearchParams(window.location.search);
