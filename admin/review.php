                                            ...
                                            <tbody>
                                                <?php 
                                                        ...
                                                        echo '
                                                            ...
                                                            <td class="text-center"><span class="badge badge-primary" onclick="message('.$row['review_id'].');" data-toggle="modal" data-target="#faderightModal'.$row['review_id'].'" style="cursor:pointer;"> View Review </span></td>
                                                            <td class="text-center">'.$row['rating'].'</td>
                                                            <td class="text-center">'.$row['modify_date'].'</td>  
                                                        </tr>';
                                                        echo '<div id="faderightModal'.$row['review_id'].'" class="modal animated fadeInRight custo-fadeInRight" role="dialog">
                                                            <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                          <p class="modal-text text-dark" >'.$row['review'].'</p>
                                                                    </div>
